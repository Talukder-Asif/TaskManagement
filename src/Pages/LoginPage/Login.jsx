      ...
      <div>
        ...
        <h3 className="text-2xl md:text-3xl text-gray-900 mb-5 lg:text-4xl font-bold">
          ...
          <form onSubmit={HandelLogin} >
            ...
            <div className="mb-6">
              <input
                ...
                required
              />
            </div><FromBtn btnName={"Sign in"}></FromBtn>
          </form>
          </div>
          ...
          <div className='flex gap-2 justify-end'>
              ...
              <div className=''>
                  <a className="border-b-2 text-lg font-semibold border-transparent hover:border-[#801f82]" href="/signup">Or create a account ?</a>
              </div>
